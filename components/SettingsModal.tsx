  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <ParchmentContainer className="w-full max-w-md max-h-[90vh] overflow-y-auto">
        <h2 className="text-2xl font-fantasy font-bold mb-4 border-b-2 border-black/20 pb-2">{t.guildRegistration}</h2>
          ...
          <div className="pt-4 border-t border-black/10">
              ...
              <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className={`flex-1 py-2 text-sm font-fantasy rounded transition-all duration-300 border-2 ${
                        importStatus === 'success' ? 'bg-green-700 text-white border-green-500 shadow-[0_0_15px_rgba(0,255,0,0.5)]' :
