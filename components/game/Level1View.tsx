            ...
            <ParchmentContainer>
                ...
                {mission.decryptedMessage.readingQuestions && mission.decryptedMessage.readingQuestions.length > 0 && (
                    <div className="space-y-6 border-t-2 border-black/10 pt-6 mt-6">
                        <h3 className="font-fantasy text-xl font-bold text-center text-[#2c1810]">{t.comprehensionQuestions}</h3>
                    ...
                    {level1State.showResults && (
                        <div className="flex items-center gap-4">
                            <div className="flex flex-col items-end">
                                ...
                                {!allCorrect && <span className="text-xs italic opacity-70">{t.reviewCorrections}</span>}
                            </div>
