...
export const DEMO_MISSION: MissionData = {
  ...
  negotiation: {
    ...
    initialStatementAudio: "/demo-audio/demo_level2_npc_start.mp3",
    ...
    script: [
      {
        ...
        audioUrl: "/demo-audio/demo_level2_npc_step1.mp3"
      },
      {
        step: 2,
        ...
        audioUrl: "/demo-audio/demo_level2_npc_step2.mp3"
      },
      {
        step: 3,
        ...
        finalReveal: true,
        audioUrl: "/demo-audio/demo_level2_npc_end.mp3"
      }
    ]
  },
